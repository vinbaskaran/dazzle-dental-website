...
export const metadata = {
  title: "Teeth Whitening in Chennai | Dazzle Dental & Cosmetic Studio",
  description:
    "Teeth Whitening at Dazzle Dental & Cosmetic Studio, Melakottaiyur, Chennai. Expert care, transparent pricing, 0% EMI. Book a free consultation.",
    ...
    <div className="App">
      <div className="min-h-screen bg-brand-light text-brand-navy pb-[57px] lg:pb-0">
        ...
        <main className="max-w-3xl mx-auto px-6 py-24">
          <h1 className="font-serif text-4xl md:text-5xl text-brand-navy">Teeth Whitening</h1>
